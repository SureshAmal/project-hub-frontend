...
export default function ThemeChanger() {
  ...
  const applyPreset = useCallback(
    (preset: ThemePreset, mode?: "light" | "dark") => {
  ...
  const updateColor = useCallback(
    (key: keyof ColorSet, value: string) => {
              ...
              <div className="flex gap-2">
                {[
                  ...
                  <button
                    ...
                    className={`flex-1 flex items-center justify-center gap-1.5 py-2.5 rounded-xl text-xs font-semibold transition-all duration-200 border ${
                      theme === mode.id
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex flex-col gap-0.5 shrink-0">
                        ...
                        <div className="flex gap-0.5">
                          ...
                          <div
                            className="size-2.5 rounded-full border border-border/50"
                            style={{
                              backgroundColor: previewColors.foreground,
                            }}
                          />
                        </div>
                      </div>
                      <div className="min-w-0">
                        <p
                          className={`text-xs font-semibold truncate ${activePreset === preset.name ? "text-primary" : "text-foreground"}`}
                        >
